...
<body>
	...
	<div class="w3-container w3-center">		
		...
		<div class="w3-padding-48">
			<img class="w3-image w3-round-large w3-hover-greyscale" src="http://localhost/project/images/delete.jpeg">
		</div>
		<div class="w3-container w3-blue w3-text w3-text-light-grey w3-hover-shadow w3-xlarge">
			<p>Your account has been removed successfully from our server.</p>
